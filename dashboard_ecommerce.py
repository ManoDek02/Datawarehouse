...
def render_global():
    try:
        ...
        layout_ca["yaxis"] = dict(title="Chiffre d'affaires (FCFA)", titlefont=dict(color=COULEURS["primaire"]))
        layout_ca["yaxis2"] = dict(title="Marge brute (FCFA)", titlefont=dict(color=COULEURS["accent"]), 
